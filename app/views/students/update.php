  ...
  <div class="container">
    ...
    <form method="POST">
      <div class="form-group">
        <input type="text" name="fname" value="<?= $student['fname'] ?>" placeholder=" " required>
        <label>First Name</label>
      </div>
      <div class="form-group">
        <input type="text" name="lname" value="<?= $student['lname'] ?>" placeholder=" " required>
        <label>Last Name</label>
      </div>
      <div class="form-group">
        <input type="email" name="email" value="<?= $student['email'] ?>" placeholder=" " required>
        <label>Email</label>
      </div>
